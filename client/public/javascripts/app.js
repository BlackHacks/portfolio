...
window.require.define({"views/templates/header": function(exports, require, module) {
  ...
  with (locals || {}) {
  var interp;
  buf.push('<div class="logo"><img src="/images/P.Y.png"/></div><div class="row-fluid"><div class="span2"></div><div class="span4"><p>Piotr Yordanov ---</p><p>Entrepreneur, Hacker and musician</p></div><div class="span1"></div><div class="span5 menu"><ul><li><a href="/" class="link"><div class="icon nav-icon-user"></div><div class="text">about</div></a></li><li><a href="/resume.pdf" class="link"><div class="icon nav-icon-address-book"></div><div class="text">resume</div></a></li><li><a href="/music" class="link"><div class="icon nav-icon-piano"></div><div class="text">music</div></a></li><li><a href="https://github.com/tUrG0n" class="link"><div class="icon nav-icon-wrench"></div><div class="text">projects</div></a></li></ul></div></div>');
  }
  return buf.join("");
  };
}});
